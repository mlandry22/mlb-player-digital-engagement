...
use_cols = ['roll12_target2_p_mean',
 'target4_p_gameday_var',
 'target4_p_gameday_mean',
 'roll12_target2_p_gameday_mean',
 'monthday',
 'teamId',
 'target2_p_gameday_var',
 'target2_p_median',
 'target4_p_median',
 'team_win_streak',
 'roll12_target2_p_median',
 'walk_off_league',
 'roll12_target4_p_gameday_var',
 'roll12_target2_p_var',
 'numberOfFollowers',
 'roll12_target4_p_median',
 'target2_p_var',
 'roll12_target2_p_gameday_median',
 'roll12_target4_p_mean',
 'roll12_target4_p_var',
 'roll12_target4_p_gameday_median',
 'eng_dayofmonth',
 'target2_p_gameday_mean',
 'roll12_target2_p_gameday_var',
 'dayofweek',
 'wpa_daily_max',
 'numberOfFollowers_delta',
 'A',
 'days_since_last_played',
 'roll12_target4_p_gameday_mean',
 'data_dayofmonth',
 'era',
 'homeRuns_rank',
 'target4_p_var']
...
#     TREES = 1400 if target=='target4' else TREES
    ...
    if not os.path.exists("./saved"):
        os.makedirs("./saved")
    lgb_model.save_model(f"./saved/lgb_{target}_v30.txt")
...
#     lgb_dval = lgb.Dataset(val[use_cols], val[target], free_raw_data=False)
    ...
    if not os.path.exists("./saved"):
        os.makedirs("./saved")
    lgb_model.save_model(f"./saved/lgb_{target}_v30_full.txt")
