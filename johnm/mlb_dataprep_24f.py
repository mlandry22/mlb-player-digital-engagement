...
train = pd.read_csv(basepath / "train_updated.csv")

eng = pkl.load(open(basepath / "train_updated_nextDayPlayerEngagement.pickle","rb"))
games = pkl.load(open(basepath / "train_updated_games.pickle","rb"))
rosters = pkl.load(open(basepath / "train_updated_rosters.pickle","rb"))
p_box_scores = pkl.load(open(basepath / "train_updated_playerBoxScores.pickle","rb"))
t_box_scores = pkl.load(open(basepath / "train_updated_teamBoxScores.pickle","rb"))
transactions = pkl.load(open(basepath / "train_updated_transactions.pickle","rb"))
standings = pkl.load(open(basepath / "train_updated_standings.pickle","rb"))
awards = pkl.load(open(basepath / "train_updated_awards.pickle","rb"))
events = pkl.load(open(basepath / "train_updated_events.pickle","rb"))
p_twitter = pkl.load(open(basepath / "train_updated_playerTwitterFollowers.pickle","rb"))
t_twitter = pkl.load(open(basepath / "train_updated_teamTwitterFollowers.pickle","rb"))


teams = pd.read_csv(basepath / "teams.csv")
players = pd.read_csv(basepath / "players.csv")
...
tf.head(1)
tf.to_csv("./tf_saved_725f.csv", compression=None)
