...
tangoRunExp = {
    "60": {
        1: 0.51400000000000001,
        2: 0.19400000000000001,
        3: 0.14999999999999999,
        4: 0.076999999999999999,
        5: 0.036999999999999998,
        6: 0.017000000000000001,
        7: 0.0060000000000000001,
        8: 0.0030000000000000001,
        9: 0.001,
        10: 0.001,
        "m": -0.216,
        "b": 0.247,
    ...
    "61": {
        1: 0.59599999999999997,
        2: 0.17599999999999999,
        3: 0.13200000000000001,
        4: 0.057000000000000002,
        5: 0.024,
        6: 0.0089999999999999993,
        7: 0.0040000000000000001,
        8: 0.001,
        9: 0.0,
        10: 0.0,
        "m": -0.11600000000000001,
        "b": 0.40600000000000003,
    },
    "62": {
        1: 0.55900000000000005,
        2: 0.20599999999999999,
        3: 0.158,
        4: 0.051999999999999998,
        5: 0.017000000000000001,
        6: 0.0050000000000000001,
        7: 0.002,
        8: 0.001,
        9: 0.0,
        10: 0.0,
        "m": -0.19900000000000001,
        "b": 0.82799999999999996,
    },
    "82": {
        1: 0.27300000000000002,
        2: 0.35499999999999998,
        3: 0.17000000000000001,
        4: 0.13800000000000001,
        5: 0.041000000000000002,
        6: 0.014999999999999999,
        7: 0.0050000000000000001,
        8: 0.001,
        9: 0.0,
        10: 0.0,
        "m": -0.20899999999999999,
        "b": 0.78900000000000003,
    },
    "80": {
        1: 0.311,
        2: 0.247,
        3: 0.17000000000000001,
        4: 0.14399999999999999,
        5: 0.070999999999999994,
        6: 0.031,
        7: 0.012999999999999999,
        8: 0.0080000000000000002,
        9: 0.0030000000000000001,
        10: 0.002,
        "m": -0.127,
        "b": 0.193,
    },
    "81": {
        1: 0.39700000000000002,
        2: 0.24399999999999999,
        3: 0.151,
        4: 0.123,
        5: 0.050999999999999997,
        6: 0.021000000000000001,
        7: 0.0080000000000000002,
        8: 0.0030000000000000001,
        9: 0.001,
        10: 0.0,
        "m": -0.14199999999999999,
        "b": 0.40200000000000002,
    },
    "20": {
        1: 0.42399999999999999,
        2: 0.29899999999999999,
        3: 0.14999999999999999,
        4: 0.071999999999999995,
        5: 0.032000000000000001,
        6: 0.012999999999999999,
        7: 0.0050000000000000001,
        8: 0.002,
        9: 0.001,
        10: 0.0,
        "m": -0.27800000000000002,
        "b": 0.71599999999999997,
    },
    "21": {
        1: 0.44400000000000001,
        2: 0.32600000000000001,
        3: 0.13700000000000001,
        4: 0.056000000000000001,
        5: 0.021999999999999999,
        6: 0.0089999999999999993,
        7: 0.0030000000000000001,
        8: 0.001,
        9: 0.0,
        10: 0.0,
        "m": -0.26800000000000002,
        "b": 0.86299999999999999,
    },
    "22": {
        1: 0.45300000000000001,
        2: 0.374,
        3: 0.11600000000000001,
        4: 0.039,
        5: 0.012,
        6: 0.0050000000000000001,
        7: 0.001,
        ...
        9: 0.0,
        10: 0.0,
        "m": -0.19400000000000001,
        "b": 0.97399999999999998,
    },
    "42": {
        1: 0.49399999999999999,
        2: 0.23699999999999999,
        3: 0.18099999999999999,
        4: 0.059999999999999998,
        5: 0.017999999999999999,
        6: 0.0070000000000000001,
        7: 0.002,
        8: 0.001,
        9: 0.0,
        10: 0.0,
        "m": -0.14399999999999999,
        "b": 0.84099999999999997,
    },
    "40": {
        1: 0.36199999999999999,
        2: 0.25600000000000001,
        3: 0.19400000000000001,
        4: 0.104,
        5: 0.048000000000000001,
        6: 0.02,
        7: 0.0089999999999999993,
        8: 0.0040000000000000001,
        9: 0.002,
        10: 0.001,
        "m": -0.16700000000000001,
        "b": 0.45000000000000001,
    },
    "41": {
        1: 0.40100000000000002,
        2: 0.25800000000000001,
        3: 0.20300000000000001,
        4: 0.083000000000000004,
        5: 0.034000000000000002,
        6: 0.012999999999999999,
        7: 0.0050000000000000001,
        8: 0.002,
        9: 0.001,
        10: 0.0,
        "m": -0.17399999999999999,
        "b": 0.66900000000000004,
    },
    "72": {
        1: 0.185,
        2: 0.54800000000000004,
        3: 0.16900000000000001,
        4: 0.067000000000000004,
        5: 0.023,
        6: 0.0060000000000000001,
        7: 0.002,
        8: 0.0,
        9: 0.0,
        10: 0.0,
        "m": -0.095000000000000001,
        "b": 0.78500000000000003,
    },
    "71": {
        1: 0.41299999999999998,
        2: 0.32800000000000001,
        3: 0.13800000000000001,
        4: 0.072999999999999995,
        5: 0.029000000000000001,
        ...
        10: 0.0,
        "m": -0.311,
        "b": 0.47799999999999998,
    },
    "70": {
        1: 0.315,
        2: 0.35599999999999998,
        3: 0.16800000000000001,
        4: 0.085999999999999993,
        5: 0.043999999999999997,
        6: 0.017999999999999999,
        7: 0.0070000000000000001,
        8: 0.0040000000000000001,
        9: 0.002,
        10: 0.0,
        "m": -0.22900000000000001,
        "b": 0.26100000000000001,
    },
    "11": {
        1: 0.59999999999999998,
        2: 0.24299999999999999,
        3: 0.097000000000000003,
        ...
        9: 0.0,
        10: 0.0,
        "m": -0.29599999999999999,
        "b": 0.98799999999999999,
    },
    "12": {
        1: 0.67300000000000004,
        2: 0.222,
        3: 0.070999999999999994,
        4: 0.023,
        5: 0.0070000000000000001,
        6: 0.002,
        7: 0.001,
        8: 0.0,
        9: 0.0,
        10: 0.0,
        "m": -0.16300000000000001,
        "b": 1.014,
    },
    "32": {
        1: 0.68600000000000005,
        2: 0.20399999999999999,
        3: 0.072999999999999995,
        ...
        10: 0.0,
        "m": -0.107,
        "b": 0.83199999999999996,
    },
    "31": {
        1: 0.59399999999999997,
        2: 0.23400000000000001,
        3: 0.104,
        4: 0.042000000000000003,
        5: 0.017000000000000001,
        6: 0.0060000000000000001,
        7: 0.0030000000000000001,
        8: 0.001,
        ...
        10: 0.0,
        "m": -0.191,
        "b": 0.69299999999999995,
    },
    "30": {
        1: 0.56599999999999995,
        2: 0.22600000000000001,
        3: 0.114,
        4: 0.052999999999999999,
        5: 0.023,
        6: 0.01,
        7: 0.0040000000000000001,
        8: 0.002,
        9: 0.001,
        10: 0.0,
        "m": -0.35799999999999998,
        "b": 0.55900000000000005,
    },
    "51": {
        1: 0.73699999999999999,
        2: 0.152,
        3: 0.067000000000000004,
        4: 0.027,
        5: 0.010999999999999999,
        6: 0.0040000000000000001,
        7: 0.001,
        8: 0.001,
        9: 0.0,
        10: 0.0,
        "m": -0.27000000000000002,
        "b": 0.47699999999999998,
    },
    "50": {
        1: 0.65400000000000003,
        2: 0.185,
        3: 0.088999999999999996,
        4: 0.041000000000000002,
        5: 0.017999999999999999,
        ...
        10: 0.0,
        "m": -0.37,
        "b": 0.35499999999999998,
    },
    "52": {
        1: 0.73199999999999998,
        2: 0.17699999999999999,
        3: 0.059999999999999998,
        4: 0.021000000000000001,
        5: 0.0070000000000000001,
        6: 0.002,
        7: 0.001,
        8: 0.0,
...
def find_playerId(x, players, rosters_players):
    ...
    if tmp.shape[0] == 1:
        ...
        # If there are two players with the same name in players, then use the
        # daily roster data to find the player on the matching team
...
# # pickle code, for aggregate features only
# for nest_type in tqdm(train.columns[1:]):
#     df_list = []
#     for i, stuff in enumerate(train.loc[train['date']<=cutoff, nest_type]):   # tolist
#         if stuff is not np.nan:
#             df = pd.read_json(stuff)
#             df['dailyDataDate'] = train.loc[i, 'date']
#             df_list.append(df)
#     df_all = pd.concat(df_list, ignore_index=True)
#     df_all.to_pickle(f'data/train_updated_{nest_type}.pickle')


# presaved from above
eng_t = pkl.load(open("./data/train_updated_nextDayPlayerEngagement.pickle", "rb"))
games_t = pkl.load(open("./data/train_updated_games.pickle", "rb"))
rosters_t = pkl.load(open("./data/train_updated_rosters.pickle", "rb"))
p_box_scores_t = pkl.load(open("./data/train_updated_playerBoxScores.pickle", "rb"))
t_box_scores_t = pkl.load(open("./data/train_updated_teamBoxScores.pickle", "rb"))
transactions_t = pkl.load(open("./data/train_updated_transactions.pickle", "rb"))
standings_t = pkl.load(open("./data/train_updated_standings.pickle", "rb"))
awards_t = pkl.load(open("./data/train_updated_awards.pickle", "rb"))
events_t = pkl.load(open("./data/train_updated_events.pickle", "rb"))
p_twitter_t = pkl.load(open("./data/train_updated_playerTwitterFollowers.pickle", "rb"))
t_twitter_t = pkl.load(open("./data/train_updated_teamTwitterFollowers.pickle", "rb"))
...
player_mapping = p_box_scores_t[["playerId", "playerName"]].drop_duplicates()
...
##################################################################################################
player_aggs = (
    eng_t.groupby("playerId")[["target1", "target2", "target3", "target4"]]
    .agg(
        {
            "target1": ["median", "var"],
            "target2": ["median", "var"],
...
player_aggs.columns = ["_".join(x) for x in player_aggs.columns]
...
game_day_player_means = eng_t.merge(p_box_scores_t[["dailyDataDate", "playerId"]])
game_day_player_means = (
    game_day_player_means.groupby("playerId")[
...
game_day_player_means = eng_t.merge(
    p_box_scores_t[["dailyDataDate", "playerId", "gamePk"]], how="left"
)
game_day_player_means["game_played"] = (
    game_day_player_means["gamePk"].notnull().astype(int)
)
off_day_player_means = (
    game_day_player_means[game_day_player_means["game_played"] == 0]
    .groupby(["playerId"])[["target1", "target2", "target3", "target4"]]
    .mean()
    .round(6)
    .reset_index()
)
off_day_player_means = off_day_player_means.rename(
    {
        "target1": "target1_p_mean_off_day",
        "target2": "target2_p_mean_off_day",
        "target3": "target3_p_mean_off_day",
        "target4": "target4_p_mean_off_day",
    },
    axis=1,
)

game_day_player_means = (
    game_day_player_means[game_day_player_means["game_played"] == 1]
    .groupby(["playerId"])[["target1", "target2", "target3", "target4"]]
    .mean()
    .round(6)
    .reset_index()
)
game_day_player_means = game_day_player_means.rename(
    {
        "target1": "target1_p_mean_game_day",
        "target2": "target2_p_mean_game_day",
        "target3": "target3_p_mean_game_day",
        "target4": "target4_p_mean_game_day",
    },
    axis=1,
)

game_day_player_vars = eng_t.merge(p_box_scores_t[["dailyDataDate", "playerId"]])
game_day_player_vars = (
    game_day_player_vars.groupby("playerId")[
        ["target1", "target2", "target3", "target4"]
    ]
    .var()
    .round(6)
...
game_day_player_vars = game_day_player_vars.rename(
    {
        "target1": "target1_p_var_game_day",
        "target2": "target2_p_var_game_day",
        "target3": "target3_p_var_game_day",
        "target4": "target4_p_var_game_day",
    },
    axis=1,
)
...
##################################################################################################
position_freq = (
    p_box_scores_t["positionType"].fillna(-999).value_counts(normalize=True).to_dict()
)

position_target_agg = eng_t.merge(
    p_box_scores_t[
...
position_target_agg.columns = [
    "_".join(x + ("position",)) for x in position_target_agg.columns
]
position_target_agg = position_target_agg.reset_index()


pitchers = players[players["primaryPositionName"] == "Pitcher"]
players["playerForTestSetAndFuturePreds"] = (
    players["playerForTestSetAndFuturePreds"].fillna(-1).astype(int)
)
players["value"] = 1
...
games_t["gameDate"] = pd.to_datetime(games_t["gameDate"])
games = games_t.sort_values("gameDate")
schedule = pd.concat(
    [
        games[["dailyDataDate", "gamePk", "homeId", "gameDate"]].rename(
            {"homeId": "teamId"}, axis=1
        ),
        games[["dailyDataDate", "gamePk", "awayId", "gameDate"]].rename(
            {"awayId": "teamId"}, axis=1
        ),
    ]
)
...
for i, data in tqdm(train.iterrows()):
    ...
    days_of_history = list(
        range(2, 21)
    )  # also could be games_of_history depending how its used
    ...
    for k, v in fielder_history_dict.items():
        ...
        for feat in fielder_history_feats:
            ...
            for day in days_of_history:
                ...
                fielding_history_features[k][f"{feat}_{day-1}_games_ago"] = d_padded[
                    day - 1
                ]
    ...
    for k, v in pitcher_history_dict.items():
        ...
        pitching_history_features[k]["days_since_last_start"] = (
            season_starts[::-1].index(1.0) if 1 in season_starts else len(season_starts)
        )
        pitching_history_features[k]["days_since_last_played"] = (
            season_played[::-1].index(1.0) if 1 in season_played else len(season_played)
        )
        for feat in pitcher_history_feats:
            ...
            for day in days_of_history:
                ...
                pitching_history_features[k][f"{feat}_{day-1}_games_ago"] = d_padded[
                    day - 1
                ]
    ...
    if not events.empty:
        events = events.sort_values(
            ["gamePk", "inning", "halfInning", "atBatIndex", "eventId"],
        ...
        walk_offs["walk_off_hr"] = (walk_offs["walk_off_hr"].isin(["Home Run"])).astype(
            int
        )
        t_tmp = t_tmp.merge(
            walk_offs[
        ...
        t_tmp = t_tmp.merge(
            hr_dist.rename({"hitterId": "playerId"}, axis=1), how="left", on="playerId"
        )
        t_tmp = t_tmp.merge(
        ...
        starters_first_hit_inning["inning"] = (
            starters_first_hit_inning["inning"] + starters_first_hit_inning["outs"] / 10
        )
        ...
        starters_first_mob_inning["inning"] = (
            starters_first_mob_inning["inning"] + starters_first_mob_inning["outs"] / 10
        )
        ...
        if not ejections.empty:
            ...
            ejections["coach_ejected"] = [
                1 if coaching_regex.search(x) else 0 for x in ejections["description"]
            ]
            ...
            ] = ejections.loc[(ejections["player_ejected"] == 1), "playerName"].apply(
    ...
    assert (
        t_tmp.shape[0] == eng_shape[0]
    ), "player_country_dummies: t_tmp length does not match engagement frame length, check for duplicated data"
    # Add games features
    ...
    assert (
        t_tmp.shape[0] == eng_shape[0]
    ), "final check: t_tmp length does not match engagement frame length, check for duplicated data"
...
excl_cols = [
    ...
    "target3_p_mean",
    "target4_p_mean",
    "gameTimeUTC_team_box_score",
    "gameDate_team_box_score",
    "dailyDataDate_team_box_score",
    "dailyDataDate_team_standings",
    "dailyDataDate_lead",
...
for target in ["target1", "target2", "target3", "target4"]:
    ...
    model_dict[target]["imp"] = pd.DataFrame(
        {"features": lgb_model.feature_name(), "gain": lgb_model.feature_importance()}
    )
